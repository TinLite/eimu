...
export default async function SideList({
    ...
    return <div className="mt-2">
        ...
        <div className="flex px-16 gap-5 w-screen overflow-x-auto items-start snap-x">
            <button className="flex flex-wrap gap-4 items-center border-2 rounded-full hover:bg-white hover:text-black absolute left-5 my-32">
            ...
            <button className="flex flex-wrap gap-4 items-center border-2 rounded-full hover:bg-white hover:text-black absolute right-5 my-32">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
