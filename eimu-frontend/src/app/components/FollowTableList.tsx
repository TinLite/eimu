...
export default function FollowTableList({ movie }: { movie: Page<MovieListEntry> }) {
    noCache(); // Do not cache the render of this page, because it's a waste of memory for thisA
